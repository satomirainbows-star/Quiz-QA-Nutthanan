...
| `@step4` | ตรวจสอบข้อความยืนยันคำสั่งซื้อแสดงในรูปแบบ `Street, City - Country` | ✅ Positive |
...
![QA Tests](https://github.com/satomirainbows-star/Quiz-QA-Nutthanan/actions/workflows/qa-tests.yml/badge.svg)